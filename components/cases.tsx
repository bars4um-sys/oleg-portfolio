...
const CASES: CaseItem[] = [
  ...
  {
    index: "Кейс 03",
    tag: "Инициативный концепт",
    title: "Из информационного лендинга — в атмосферу кинопремьеры",
    description:
      "Инициативный концепт редизайна страницы онлайн-интенсива по английскому языку. Проект создан как предложение автору курса и демонстрация моего подхода к структуре, визуальной подаче и адаптивному прототипированию. Концепция не публиковалась на сайте школы и не тестировалась на реальном трафике.",
    image: "/cases/titanic-case.webp",
    cta: "Смотреть концепцию",
    href: "/titanic",
    was: "Страница курса с минимальным визуальным оформлением.",
    became: "Концепция нового визуального языка и структуры лендинга.",
  },
]
