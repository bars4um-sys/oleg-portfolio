...
const CASES: CaseItem[] = [
  ...
  },
  {
    ...
    description:
      "Инициативный концепт редизайна страницы онлайн-интенсива по английскому языку. Проект создан как предложение заказчику и демонстрация моего подхода к структуре, визуальной подаче и адаптивной вёрстке. Концепция пока не запущена, результаты не измерялись.",
