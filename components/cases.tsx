...
const CASES: CaseItem[] = [
  ...
  {
    index: "Кейс 03",
    tag: "ИНИЦИАТИВНЫЙ КОНЦЕПТ · EDTECH",
    title: "Из текстового лендинга — в кинематографичную страницу курса",
    description:
    ...
    href: "/titanic",
    was: "Текстовая страница курса с минимальным визуальным оформлением.",
    became: "Авторская концепция нового визуального языка и структуры лендинга.",
  },
]
