...
const BLOCKS = [
  ...
  },
  {
    ...
    goal: 'Наглядно показать структуру и последовательность обучения',
    before: 'Процесс обучения был описан преимущественно текстом',
    after: 'Последовательный таймлайн с этапами, заданиями и материалами курса',
  },
  {
    n: '03',
  ...
  },
  {
    ...
    before: 'Три варианта участия с подробным текстовым описанием условий',
  ...
  },
  {
    n: '07',
    title: 'FAQ и подвал',
    goal: 'Собрать ответы на частые вопросы перед выбором тарифа',
