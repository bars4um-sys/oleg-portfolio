        ...
        <div>
          ...
          <Reveal delay={160}>
            <p className="mt-6 text-pretty text-lg leading-relaxed text-muted-foreground">
              Мне интереснее всего работать не с пустым холстом, а со сложным материалом. Когда есть
              десятки страниц, разные смыслы, программы, методички и экспертный опыт — моя задача
              собрать из этого систему, в которой человеку легко разобраться.
            </p>
          </Reveal>
          <Reveal delay={240}>
