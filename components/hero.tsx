      ...
      <div className="relative mx-auto max-w-6xl px-6 pb-24 pt-20 md:pt-28">
        ...
        <Reveal delay={240}>
          <p className="mt-8 max-w-2xl text-pretty text-lg leading-relaxed text-muted-foreground">
            Разрабатываю посадочные страницы, презентации и материалы курсов для экспертов и бизнеса. Превращаю
            объёмные тексты в понятную систему — с опорой на цифры, ясную логику и мгновенное считывание смыслов.
          </p>
        </Reveal>
