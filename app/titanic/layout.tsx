...
export const metadata: Metadata = {
  ...
  description:
    'Инициативная концепция редизайна лендинга онлайн-интенсива «Titanic English». Разбор структуры, визуальной системы и адаптивного прототипа. Без запуска на реальном трафике.',
  openGraph: {
