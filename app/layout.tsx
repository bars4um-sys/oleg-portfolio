...
export const metadata: Metadata = {
  ...
  description:
    'Превращаю сложные материалы и программы в понятные сайты, где легко увидеть главное и принять решение. Посадочные страницы, презентации и материалы курсов для экспертов и бизнеса.',
  openGraph: {
    type: 'website',
  ...
  return (
    ...
    >
      <body className="font-sans antialiased">
        <div className="film-grain-global" aria-hidden="true" />
        {children}
      </body>
    </html>
  )
